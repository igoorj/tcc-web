...
public class CadastroQuestionarioController extends CommonsController {
	...
	/*
	 * Salva ou atualiza o question√°rio do semestre atual. Se estiver editando o
	 * quetion√°rio, s√≥ salva as altera√ß√µes das perguntas.
	 */
			...
			if (editing) {
				if (perguntaBusiness.deleteList(oldQuestions)) {
					if (perguntaBusiness.saveList(questions)) {
						Messagebox.show("Question·rio atualizado.", "Sucesso",
								Messagebox.OK, Messagebox.INFORMATION);
						window.detach();
					} else
						Messagebox.show("Question·rio n„o foi atualizado!",
								"Erro", Messagebox.OK, Messagebox.ERROR);
				} else {
					Messagebox.show("Question·rio n„o foi atualizado 2!",
							"Erro", Messagebox.OK, Messagebox.ERROR);
				}
				...
				if (questionarioBusiness.save(questionary)) {
					...
					if (perguntaBusiness.saveList(questions)) {
						Messagebox.show("Question·rio cadastrado com sucesso.",
					...
					Messagebox.show("Question·rio n„o foi adicionado!", "Erro",

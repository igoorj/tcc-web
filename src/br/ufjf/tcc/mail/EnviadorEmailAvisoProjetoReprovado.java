...
//		String nomeCoordenador = coordenadores.get(0).getNomeUsuario();
		...
		emailBuilder.appendMensagem("O(a) discente tem até 7 (sete) dias corridos após o fim do prazo para corrigir o Projeto e submeter a versão corrigida no Sistema de Monografias.").breakLine(); 
